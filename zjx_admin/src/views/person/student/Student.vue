<template>
  <div class="app-container">
    ...
    <el-drawer
      ...
      <student-search @click-get-data="getData"/>
    </el-drawer>
    ...
    <el-table :data="list" border stripe @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="sex" label="性别 1：男   2：女" width="100" align="center"/>
      <el-table-column prop="birth" label="出生年月日" width="100" align="center"/>
      <el-table-column prop="graduateDate" label="毕业日期" width="100" align="center"/>
      ...
      <el-table-column prop="wxId" label="微信openid" width="100" align="center"/>
      <el-table-column prop="avatar" label="头像地址" width="100" align="center"/>
      <el-table-column prop="sign" label="个性签名" width="100" align="center"/>
